   ...
   return (
     <section className="relative pt-36 pb-20 px-6 max-w-7xl mx-auto text-center overflow-hidden">
        ...
        <h1 className="text-5xl sm:text-7xl font-extrabold tracking-tight text-white max-w-4xl mx-auto leading-[1.1] mb-8">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-accent via-indigo-300 to-white">Real-Time Data</span>
        </h1>

        <p className="text-gray-400 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed font-normal">
          Deploy asychronous microservices, orchestrate high-throughput APIs, and stream live telemetry
          across distributed global environment with zero downtime.
        </p>

        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          <a href="#features" className="w-full sm:w-auto bg-brand-500 hover:bg-brand-600 text-white
           px-8 py-3.5 rounded-xl font-bold text-sm transition-all shadow-lg shadow-brand-500/25">Explore Capability Matrix</a>
          <a href="#architecture" className="w-full sm:w-auto bg-dark-card border border-dark-border hover:border-500/50 text-gray-200 px-8 py-3.5 rounded-xl font-bold text-sm transition-all">View Technical Stack</a>
        </div>
